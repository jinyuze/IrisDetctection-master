...
cv::String eye_cascade_name = "/Users/yuze/ProgramCoding/IrisDetctection/haarcascade_eye3.xml";
...
int main( int argc, const char** argv ) {
    cv::Mat frame;
    bool image = 1; //set 0 for video and 1 for image
    String image_path = "/Users/yuze/Desktop/Code/测试集合/5.png";
...
void detectAndDisplayEye( cv::Mat & frame ) {
    ...
    cv::Mat frame_gray = rgbChannels[0];
    Mat gray_image;
    cv::cvtColor( frame, gray_image, CV_BGR2GRAY );
    
    //-- Detect eyes
    eye_cascade.detectMultiScale( frame_gray, eyes, 1.05, 2, 0  ,cv::Size(2, 2),cv::Size(100,100));
